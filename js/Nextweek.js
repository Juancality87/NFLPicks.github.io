...
function Load_datesstring(){
    ...
    $.ajax({
        type: "GET",
        url: api_url + "/Schedule/GET_datesString?type=next",        
        async: false,
        dataType: "json",
...
function Post_sched(data){
    ...
    $.ajax({
        type: "POST",
        url: api_url + "/Schedule/Post_NextSchedule",
        data: data,
...
function GET_Schedule_Games(){
    ...
    $.ajax({
        type: "GET",
        url: api_url + "/Schedule/GET_Next_Schedule_Games",
        crossDomain: true,
...
function Grid_Configuration() {
    ...
    var row = document.getElementById('table').rows;    
        ...
        for (var i = 0; i < row.length; i++) {
            ...
            row[i].cells[0].innerHTML += "<img src='"+row[i].cells[1].innerHTML+"' style='width:90px;'/>";        
            row[i].cells[2].innerHTML += "<p><strong>"+row[i].cells[3].innerHTML+"</strong></p><p>"+row[i].cells[4].innerHTML+"</p>";
            row[i].cells[5].innerHTML += "<img src='"+row[i].cells[6].innerHTML+"' style='width:90px;'/>";           
...
function Grid_Configuration2() {
    ...
    var row2 = document.getElementById('table2').rows;
        ...
        for (var i = 0; i < row2.length; i++) {
            ...
            row2[i].cells[0].innerHTML += "<img src='"+row2[i].cells[1].innerHTML+"' style='width:90px;'/>";        
            row2[i].cells[2].innerHTML += "<p><strong>"+row2[i].cells[3].innerHTML+"</strong></p><p>"+row2[i].cells[4].innerHTML+"</p>";
            row2[i].cells[5].innerHTML += "<img src='"+row2[i].cells[6].innerHTML+"' style='width:90px;'/>";    
...
function GET_ByeWeek_teams(){
    ...
    $.ajax({
        type: "GET",
        url: api_url + "/Schedule/byeNextweek",        
        crossDomain: true,
        withCredentials: true,
        async: false,
        dataType: "json",
